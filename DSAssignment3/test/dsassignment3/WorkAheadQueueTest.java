 ...
 *
 * @author xiaotuwang. Revised for spring 2021, nblong.
 */
public class WorkAheadQueueTest {
    ...
    public void testDequeue_int() {
        System.out.println("testDequeue_int");
    ...
    public void testFirst_int() throws Exception {
        System.out.println("testFirst_int");
        buildQueue(0);
    ...
    public void testFirstThreeNodes() {
        System.out.println("testFirstThreeNodes");
        buildQueue(0);
        /*
    ...
    public void testFirstThreeElements() {
        System.out.println("testFirstThreeElements");
        buildQueue(0);
        /*
     ...
     * 3, 4, 5} and an n-element ArrayList of Integers with the same values as
     * the queue.
     */
